...
function reloadProducts(data){
    ...
    $.post(url,data,function (msg) {
        ...
        $.each(msg,function (index,value) {
            ...
            var productTag = '<div class="one-product"><div class="contain-product"><a href="product/index/'+value['id']+'"><div class="photo"><img src="public/images/33.jpg"></div><div class="pro-details"><label class="pro-title">'+value['title']+'</label><label class="pro-price">'+parseInt(value['price']).toLocaleString()+' تومان</label></div><button class="iranyekan">مشاهده محصول</button></a></div></div>';
